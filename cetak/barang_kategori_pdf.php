...
$pdf->Cell(190, 10, 'LAPORAN DATA BARANG', 0, 0, 'C');
...
$pdf->Cell(20, 7, 'Tersedia', 1, 0, 'C');
$pdf->Cell(25, 7, 'Ditempatkan', 1, 0, 'C');
$pdf->Cell(20, 7, 'Dipinjam', 1, 0, 'C');
...
while ($d = mysqli_fetch_array($myQry)) {
    ...
    $pdf->Cell(15, 6, $d['kd_barang'], 1, 0, 'C');
    $pdf->Cell(70, 6, $d['nm_barang'], 1, 0);
    if (isset($_SESSION["SES_PETUGAS"]) && ($_SESSION["SES_UNIT"])) {
        $pdf->Cell(20, 6, $dataRow['total'], 1, 0, 'C');
    } else {
        $pdf->Cell(20, 6, $d['jumlah'], 1, 0, 'C');
    }
    $pdf->Cell(20, 6, $jumTersedia, 1, 0, 'C');
    $pdf->Cell(25, 6, $jumDitempatkan, 1, 0, 'C');
    $pdf->Cell(20, 6, $jumDipinjam, 1, 1, 'C');
}
