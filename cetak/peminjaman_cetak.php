...
if ($_GET) {
  ...
  $mySql = "SELECT peminjaman.*, pegawai.nm_pegawai, petugas.nm_petugas, departemen.nm_departemen FROM peminjaman 
...
<body onLoad="javascript:window.print()">
  ...
  <table width="550" border="0" cellspacing="1" cellpadding="4" class="table-print">
    ...
    <tr>
      <td><b>Pegawai </b></td>
      <td><b>:</b></td>
      <td valign="top"><?php echo $myData['nm_pegawai'] . " | " . $myData['nm_departemen']; ?></td>
    </tr>
    <tr>
  ...
  <table class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
    ...
    <tr>
      ...
      <td width="395" bgcolor="#F5F5F5"><b>Type</b></td>
