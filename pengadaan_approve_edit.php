			...
			<div class="row">
				...
				<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-lg-4">
							<input id="date" class="form-control" name="txtTanggal" placeholder="dd-mm-yyyy" value="<?php echo IndonesiaTgl($tglTransaksi); ?>" autocomplete="off" style="display: block; margin-bottom: 12px;">
						</div>
						<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="form-group">
                            			...
                            			<img style='border: 1px solid #ddd; border-radius: 5px; padding: 5px;' width='150px' src='user_data/" . $ex[$i] . "'>
														...
														<div class="form-group">
															<label for="StatusBarang" class="col-lg-2 control-label">Status Barang</label>
															<div class="col-lg-4" style="display: block; margin-bottom: 12px;">
																<select name="StatusBarang" data-live-search="true" class="selectpicker show-tick form-control" autocomplete="off">
