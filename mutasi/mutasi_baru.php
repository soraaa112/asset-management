...
if(isset($_POST['btnSimpan'])){
	...
	if(count($pesanError)>=1 ){
		...
		if($my2Qry){
			...
			echo "<script>";
			echo "window.open('../cetak/mutasi_cetak.php?noMutasi=$_POST[txtNomor]', width=330,height=330,left=100, top=25)";
			echo "</script>";
		}
	}	
}
...
<table width="900" cellpadding="3" cellspacing="1" class="table-list">
	...
	<tr>
	  <td>&nbsp;</td>
	  <td>&nbsp;</td>
	  <td><a href="javaScript: void(0)" target="_self" onclick="popup('pencarian_barang_terpakai.php')"><strong>Pencarian Barang</strong></a>,<strong></strong> untuk membaca label barang </td>
    </tr>
	<tr>
	  <td>&nbsp;</td>
	  <td>&nbsp;</td>
