...
<br />
<a href="cetak/pengadaan_supplier.php?kodeSupplier=<?php echo $dataSupplier; ?>&tahun=<?php echo $dataTahun; ?>" target="_blank"><img src="images/btn_print2.png"  border="0" title="Cetak ke Format HTML"/></a>
</div>