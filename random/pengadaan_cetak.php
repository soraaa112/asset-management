...
if ($_GET) {
  ...
  $mySql = "SELECT pengadaan.*, supplier.nm_supplier, petugas.nm_petugas, departemen.nm_departemen, approval.keterangan 
  FROM pengadaan 
...
<body onLoad="javascript:window.print()">
  ...
  <table width="500" border="0" cellspacing="1" cellpadding="4" class="table-print">
    ...
    <tr>
      ...
      <td><b>:</b></td>
      <td valign="top"><?php echo IndonesiaTgl2($myData['tgl_pengadaan']); ?></td>
    </tr>
    <tr>
      <td><b>Supplier</b></td>
      <td><b>:</b></td>
  ...
  <table class="table-list" width="900" border="0" cellspacing="1" cellpadding="2">
    ...
    <tr>
      ...
      <td width="269" bgcolor="#F5F5F5"><b>Type</b></td>
      <td width="247" bgcolor="#F5F5F5"><strong></strong></td>
    ...
    $mySql = "SELECT pengadaan_item.*, barang.nm_barang, kategori.nm_kategori, pengadaan.status_approval FROM pengadaan_item 
