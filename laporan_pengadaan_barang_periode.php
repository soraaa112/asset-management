...
<div class="table-border">
    ...
    <table width="900" border="0" class="table-list">
      ...
      <tr>
        ...
        <td width="770"><input name="txtTanggalAwal" type="text" class="tcal" value="<?php echo $tglAwal; ?>" />
          s/d
          <input name="txtTanggalAkhir" type="text" class="tcal" value="<?php echo $tglAkhir; ?>" />
        </td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        ...
        <td><input name="btnTampil" type="submit" value=" Tampilkan " />
          <input name="btnCetak" type="submit" value=" Cetak " />
        </td>
      </tr>
    </table>
  </form>
  ...
  <table class="table-list" width="900" border="0" cellspacing="1" cellpadding="2">
    <tr>
      ...
      <td width="369" bgcolor="#CCCCCC"><b>Type</b></td>
  ...
  <a href="cetak/pengadaan_barang_periode.php?tglAwal=<?php echo $tglAwal; ?>&tglAkhir=<?php echo $tglAkhir; ?>" target="_blank"><img src="images/btn_print2.png" border="0" title="Cetak ke Format HTML" /></a>
</div>