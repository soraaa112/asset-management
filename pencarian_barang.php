...
if (trim($dataKategori) == "Semua") {
	...
	$filterSQL = "WHERE barang_inventaris.status_barang = 'Tersedia'";
} else {
	// Jika kategori milih data, dan Kata Kunci tidak diisi
	$filterSQL = "WHERE kd_kategori='$dataKategori' AND barang_inventaris.status_barang = 'Tersedia'";
}
		...
		<div style="overflow-x:auto;">
			...
			<table id="example1" class="table-list" width="100%" border="0" cellspacing="1" cellpadding="2">
				...
				<tbody>
					...
					$mySql = "SELECT barang_inventaris.*, petugas.nm_petugas, departemen.nm_departemen, barang.nm_barang, pengadaan.no_pengadaan, pengadaan.status_approval FROM barang_inventaris
					...
					$filterSQL AND pengadaan.status_approval != 'Belum Approve'
			...
			<ul>
				<li>Klik Kode Label jika ingin memilih barang</li>
			</ul>
		</div>
	</div>
</body>
