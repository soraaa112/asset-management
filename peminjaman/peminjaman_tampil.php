...
<title>Daftar Transaksi Terakhir - IRAMA KOMPUTER</title>
...
<table class="table-list" width="900" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr bgcolor="<?php echo $warna; ?>">
    ...
    <td width="46" align="center"><a href="?open=Peminjaman-Hapus&Kode=<?php echo $Kode; ?>" target="_self"
  ...
  <tr>
	...
	for ($h = 1; $h <= $max; $h++) {
		...
		echo " <a href='?open=Laporan-Peminjaman&hal=$list[$h]&bulan=$dataBulan&tahun=$dataTahun'>$h</a> ";
	}
	?></td>
  </tr>
</table>
