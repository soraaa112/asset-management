<body>
  ...
  $pageSql = "SELECT * FROM vendor_service";
  ...
  <div class="table-border">
    <div style="overflow-x:auto;">
      <h2><b>DATA VENDOR SERVICE </b><a href="?open=Vendor-Add" target="_self"><img src="images/btn_add_data.png" border="0" /></a></h2>
      <table id="example1" class="table-list" width="100%" border="0" cellspacing="1" cellpadding="2">
        <thead>
          <tr>
            <th width="21" align="center">No</th>
            <th width="45">Kode</th>
            <th width="180">Nama Vendor </th>
        ...
        <tbody>
          ...
          while ($myData = mysql_fetch_array($myQry)) {
            $nomor++;
            $Kode = $myData['kd_vendor_service'];
            $vendor = $myData['nm_vendor_service'];
          ...
          ?>
            <tr bgcolor="<?php echo $warna; ?>">
              ...
              <td align="center">
                <a href="?open=Vendor-Delete&Kode=<?php echo $Kode; ?>" target="_self" alt="Delete Data" onclick="return confirm('ANDA YAKIN AKAN MENGHAPUS DATA VENDOR ( <?php echo $vendor; ?> ) INI ... ?')">
                  <button class="btn btn-danger" title="Hapus Data"><i class="fa fa-trash"></i>
                  </button>
                </a>
                &nbsp;
                <a href="?open=Vendor-Edit&Kode=<?php echo $Kode; ?>" target="_self" alt="Edit Data">
