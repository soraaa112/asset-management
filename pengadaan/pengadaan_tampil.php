...
<table class="table-list" width="900" border="0" cellspacing="0" cellpadding="2">
  <tr>
  ...
  <tr bgcolor="<?php echo $warna; ?>">
    ...
    <td width="40" align="center"><a href="?open=Pengadaan-Hapus&Kode=<?php echo $Kode; ?>" target="_self"
