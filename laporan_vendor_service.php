<body>
    ...
    <div style="overflow-x:auto;">
        <div class="table-border">
            ...
            <table id="example1" class="table-list" width="900" border="0" cellspacing="1" cellpadding="2">
                <thead>
                    <tr>
                        ...
                        <td width="200" bgcolor="#CCCCCC"><strong>Nama Vendor Service </strong></td>
            ...
            <a href="cetak/vendor_service.php" target="_blank"><img src="images/btn_print2.png" border="0" title="Cetak ke Format HTML" /></a>
        </div>
    </div>